...
window.I18N = {
  en: {
    ...
    'db-source-label': 'Database Connection',
    ...
    'pm-grid-hint': 'Patient data loads automatically from the database — click any row to auto-fill the form on the left.',
    ...
    'api-banner': "This app now talks only to your own FastAPI backend — the LLM provider key lives server-side in .env and never touches the browser.",
    'api-provider-title': 'Backend Connection',
    ...
    'cb-goto-global': 'View full dataset in Global Analysis',
  ...
  ar: {
    ...
    'db-source-label': 'اتصال قاعدة البيانات',
    ...
    'pm-grid-hint': 'يتم تحميل بيانات المرضى تلقائيًا من قاعدة البيانات — اضغط على أي صف لتعبئة النموذج تلقائيًا.',
    ...
    'api-banner': 'هذا التطبيق يتواصل الآن فقط مع الـ FastAPI backend الخاص بك — مفتاح مزوّد الذكاء الاصطناعي يبقى على السيرفر داخل .env ولا يصل للمتصفح إطلاقًا.',
    'api-provider-title': 'اتصال الـ Backend',
    ...
    'cb-goto-global': 'اعرض البيانات كاملة في لوحة التحليل العالمي',
